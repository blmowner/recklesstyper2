    <div class='form-group'>
        <div class=" col-sm-12">
            <!--<a class="btn btn-default" href="/patients/{{ $patient->patient_id }}" role="button">Back</a>
...
<ul class="nav nav-tabs">
  ...
  <li><a data-toggle="tab" href="#menu0">Identification</a></li>
  <li><a data-toggle="tab" href="#menu1">Contact Information</a></li>
  <li><a data-toggle="tab" href="#menu2">Address</a></li>
  <!--<li><a data-toggle="tab" href="#menu3">Current  & Permanent Address</a></li>-->
</ul>
...
<br>
    ...
    <div class='form-group  @if ($errors->has('patient_new_ic')) has-error @endif'>
        {{ Form::label('New Identification', 'New ID.No',['class'=>'col-md-4 control-label']) }}
        <div class='col-md-8'>
    ...
    <div class='form-group  @if ($errors->has('patient_old_ic')) has-error @endif'>
        {{ Form::label('Old Identification', 'Old ID.No',['class'=>'col-md-4 control-label']) }}
        <div class='col-md-8'>
 ...
 <div class='form-group  @if ($errors->has('patient_birth_certificate')) has-error @endif'>
        {{ Form::label('Birth Certificate', 'Birth Cert.',['class'=>'col-md-4 control-label']) }}
        <div class='col-md-8'>
...
<br>
 ...
 <div class='form-group  @if ($errors->has('patient_phone_home')) has-error @endif'>
        {{ Form::label('Phone Home', 'Home No.',['class'=>'col-md-4 control-label']) }}
        <div class='col-md-8'>
    ...
    <div class='form-group  @if ($errors->has('patient_phone_mobile')) has-error @endif'>
        {{ Form::label('Phone Mobile', 'Mobile No.',['class'=>'col-md-4 control-label']) }}
        <div class='col-md-8'>
	...
	<div class="row">
			<div class="col-xs-6">
					<div class='form-group  @if ($errors->has('patient_phone_office')) has-error @endif'>
						{{ Form::label('Phone Office', 'Office No.',['class'=>'col-md-4 control-label']) }}
						<div class='col-md-8'>
			...
			<div class="col-xs-6">
					<div class='form-group  @if ($errors->has('patient_phone_fax')) has-error @endif'>
						{{ Form::label('Phone Fax', 'Fax No.',['class'=>'col-md-4 control-label']) }}
						<div class='col-md-8'>
